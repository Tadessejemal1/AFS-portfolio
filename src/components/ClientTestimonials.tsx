    ...
    <section className="section off testimonials-section">
      <div className="wrap testimonials-layout">
        <div className="testimonials-intro">
          ...
          <p className="testimonials-hint testimonials-hint-desktop">{t("home.quotes.scrollHint")}</p>
          <p className="testimonials-hint testimonials-hint-mobile">{t("home.quotes.swipeHint")}</p>
        </div>
